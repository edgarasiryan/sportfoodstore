...
class ProductDetailViewTest(TestCase):
    def test_get_product_by_slug(self):
        ...
        uploaded = SimpleUploadedFile( 'small_gif', small_gif, content_type='image/gif')
...
class CategoryListViewTest(TestCase):
    def setUp(self):
        ...
        self.product = ProductProxy.objects.create(title = 'Test Product', slug = 'test-product', category=self.category, image = uploaded)
